...
import { pickAlhaurinGrid, pickPuertaBlancaGrid, type GridCamera } from '@/lib/cctv-priority';
...
function GridCell({
  ...
  return (
    <div className="group relative h-full min-h-0 overflow-hidden border border-[var(--map-cctv)]/40 bg-black">
      ...
      <div className="pointer-events-none absolute left-1.5 top-1.5 z-[2] flex items-center gap-1 bg-black/70 px-1.5 py-0.5">
      ...
      <div className="flex shrink-0 items-center justify-between gap-3 border-t border-white/10 bg-black/90 px-3 py-2">
        <div className="min-w-0">
          ...
          <p className="font-mono text-[8px] tracking-wider text-white/40">
            {cam.city ?? '—'} · {cam.source ?? 'CCTV'} · esc to return to grid
          </p>
        </div>
